...
本规格与 P4-B 分步 TDD 实施计划已经用户书面批准，实施授权自 2026-08-04 生效。P4-B 已按批准边界完成实现、独立审查和任务 30 全部门禁；2026-08-30，Project 4（P4-A + P4-B）完成最终验收。

最终代码候选、CI run、7 个必需 job、Windows 本地门禁、独立审查与范围核对的不可变证据统一记录在 [P4-B 实施计划的“实施完成与最终验收记录”](../plans/2026-08-04-controlled-delivery-merge-cleanup.md#实施完成与最终验收记录)，本规格不复制第二份易漂移清单。P4-C/P4-D 仍是未来独立项目，不属于本次验收欠账。
