...
use crate::delivery::merges::proof::MergeCommitObjectProof;
use crate::delivery::{DeliveryError, DeliveryOperationId, DeliveryVersion};

#[derive(Clone, PartialEq, Eq)]
pub struct EnterMergePendingRequest {
    ...
    pub(in crate::delivery::merges) proof: MergeCommitObjectProof,
}

impl EnterMergePendingRequest {
    pub fn try_new(
        task_id: TaskId,
        operation_id: DeliveryOperationId,
        expected_version: DeliveryVersion,
        proof: MergeCommitObjectProof,
...
impl fmt::Debug for EnterMergePendingRequest {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        formatter
            .debug_struct("EnterMergePendingRequest")
